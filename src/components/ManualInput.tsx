...
export function ManualInput() {
  ...
  function addCard() {
    // For adding more cards during play (hitting)
    setStep('player')
  }
    ...
    <div className="h-full flex flex-col bg-gray-950 p-4">
      ...
      {step === 'play' ? (
        <div className="space-y-3 pb-4">
          <div className="text-center text-xs text-gray-500 mb-2">What do you do?</div>
      ...
      {/* Reset button */}
      <button onClick={reset} className="text-gray-600 text-xs text-center py-2">
        Reset Hand
      </button>
    </div>
  )
